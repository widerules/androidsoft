 ...
 * @author pierre
 */
public class POIOverlayResources
{
    private int mLayout;
    ...
    /**
     * @return the innerLayoutId
     */
    public int getInnerLayoutId()
    {
        return mInnerLayoutId;
    }

    /**
     * @param innerLayoutId the innerLayoutId to set
     */
    public void setInnerLayoutId(int innerLayoutId)
    {
        mInnerLayoutId = innerLayoutId;
    }

    /**
     * @return the mainLayoutId
     */
    ...
    /**
     * @param mainLayoutId the mainLayoutId to set
     */
    public void setMainLayoutId(int mainLayoutId)
    {
        mMainLayoutId = mainLayoutId;
    }
